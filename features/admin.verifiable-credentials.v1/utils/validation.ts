...
export function isValidFormatAlgorithmCombination(
    ...
    // Relaxed validation: Allow any algorithm for any format
    return true;
}
...
export function getValidAlgorithmsForFormat(format: VCFormat): ProofAlgorithm[] {
    // Relaxed validation: Return all supported algorithms regardless of format
    return Object.values(ProofAlgorithm);
}
