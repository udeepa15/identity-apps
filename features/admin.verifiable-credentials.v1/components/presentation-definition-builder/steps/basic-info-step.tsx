                        ...
                        <Grid.Column mobile={16} tablet={16} computer={10}>
                            <Field.Dropdown
                                ...
                                onChange={(e: any, { value }: { value: string }) => {
                                    onChange({ didMethod: value, signingAlgorithm: "EdDSA" });
                                }}
                                data-componentid={`${componentId}-did-method-dropdown`}
                            />
                            <Hint>
                                Select the DID method for the verifier identity.
                            </Hint>
                        </Grid.Column>
                    </Grid.Row>

                    {/* Signing Algorithm Field (Fixed) */}
                    <Grid.Row columns={1}>
                        <Grid.Column mobile={16} tablet={16} computer={10}>
                            <Field.Input
                                ...
                                maxLength={100}
                                minLength={0}
                                data-componentid={`${componentId}-signing-algorithm-readonly`}
                            />
                            <Hint>
                                The signing algorithm is fixed to EdDSA (Ed25519) for verifier authentication.
                            </Hint>
                            <input type="hidden" value="EdDSA" />
                        </Grid.Column>
                    </Grid.Row>
